...
ggplot(power_results, aes(x = true_mu, y = power)) +
  ...
  theme_minimal()
```
As the true value of mu increases, power increases and leaves off around true value of mu value of 5. 
...
Is the sample average of 𝜇̂ 
 across tests for which the null is rejected approximately equal to the true value of 𝜇
? Why or why not?

The sample average of 𝜇is relatively the same across all values of true mu except for some higher values for the estimate around true mu 1 and 2. 
